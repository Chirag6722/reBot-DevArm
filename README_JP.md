...
| **Pinocchio 統合** | ✅ 完了 | Pinocchio フレームワークへの対応により、ロボットアームの順運動学/逆運動学および重力補償を実現 | [Getting Started with Pinocchio for reBot Arm B601-DM](https://wiki.seeedstudio.com/rebot_arm_b601_dm_pinocchio_meshcat/) and [Github repo](https://github.com/Seeed-Projects/reBotArm_control_py) |
| **Isaac Sim シミュレーション** | 🚧 進行中 | USD モデルをインポートし、シミュレーションによる遠隔操作を実現 |[Wiki](https://wiki.seeedstudio.com/rebot_arm_b601_dm_isaacsim/)|
...
### reBot Arm B601 RS
| 対応エコシステム                                                                  | ステータス | 説明 / 推定リリース日                                                                                                                                | 関連ドキュメント                                                                                                                                                                              |
| :-------------------------------------------------------------------------------- | :--------: | :-------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **モーターの基本利用**                                                            |   ✅ 完成  | 基本的な動作制御と API のカプセル化                                                                                                                  | [Robstride](https://wiki.seeedstudio.com/cn/robstride_control/)                                                                                                                                |
| **新しい 3D STEP 構造部品と BOM のオープンソース公開**                            |   ✅ 完成  | 新バージョンの全 STEP ファイル、部品表（BOM）、およびすべての加工部品の参考価格                                                                      | [reBot Arm B601-RS BOM](./hardware/reBot_B601_RS/readme.md)                                                                                                                                  |
| **はじめに (Getting Started)**                                                    |   ✅ 完成  | B601-RS クイックスタートガイド                                                                                                                       | [reBot Arm B601-RS 入門ガイド](https://wiki.seeedstudio.com/rebot_b601_rs_getting_started/)                                                                                                  |
| **組み立て動画**                                                                  |   ✅ 完成  | 非常に詳細な組み立て手順と解説動画                                                                                                                   | [reBot Arm B601-RS 組み立て動画](https://wiki.seeedstudio.com/rebot_b601_rs_getting_started/)                                                                                                |
| **ROS2 (Humble)**                                                                 |   ✅ 完成  | reBot Arm コントローラーを ROS2 に統合。kinematics、軌道計画、重力補償、MoveIt2 に対応                                                              | [reBot Arm B601-DM ROS2 統合ガイド](https://wiki.seeedstudio.com/rebot_arm_b601_rs_ros2_integration/)                                                                                          |
| **LeRobot 統合**                                                                  |   ✅ 完成  | Hugging Face LeRobot トレーニングフレームワークへの適応                                                                                              | [reBot Arm LeRobot 入門ガイド](https://wiki.seeedstudio.com/rebot_arm_b601_rs_lerobot/)                                                                                                      |
| **Pinocchio 統合**                                                                |   ✅ 完成  | Pinocchio フレームワークへの適応により、ロボットアームの順運動学・逆運動学・重力補償を実現                                                            | [reBot Arm B601-DM Pinocchio 入門ガイド](https://wiki.seeedstudio.com/rebot_arm_b601_rs_pinocchio_meshcat/) および [Github リポジトリ](https://github.com/Seeed-Projects/reBotArm_control_py) |
| **深度カメラ統合**                                                                |   ✅ 完成  | YOLO と深度カメラに基づくビジュアル把持のデモンストレーション                                                                                       | [ビジュアル把持デモ入門ガイド](https://wiki.seeedstudio.com/rebot_arm_b601_dm_grasping_demo/)                                                                                                |
...
| **Isaac Sim シミュレーション**                                                     |   ✅ 完成 | USD モデルのインポートとシミュレートテレオペレーションの有効化                                                                                       | [DLI コース](https://www.seeedstudio.com/sim-to-real-with-seeed-rebot-and-nvidia-isaac) & [Github リポジトリ](https://github.com/Seeed-Projects/reBot-Isaacsim)                                  |
| **最新アルゴリズムの段階的なアップデート**                                         |   ⏳ 予定 | 産業界で一般的に使用されているアルゴリズムを段階的に統合                                                                                            | 進行中                                                                                                                                                                                        |
| **完全無料コースシリーズの開講**                                                   |   ⏳ 予定 | 主要なアルゴリズムを網羅する無料コースを段階的に公開                                                                                                | 進行中                                                                                                                                                                                        |
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="8" align="center"><strong>カメラ</strong></td>
      <td rowspan="6" align="center">デプスカメラ</td>
    ...
    <tr>
      <td rowspan="2" align="center">単眼カメラ</td>
    ...
    <tr>
      <td rowspan="2" align="center"><strong>マイク</strong></td>
      <td rowspan="2" align="center">マイクアレイ</td>
    ...
    <tr>
      <td rowspan="2" align="center"><strong>コントローラー</strong></td>
      <td rowspan="2" align="center">エッジコントローラー</td>
